...
각 참여자는 지정된 **화자 번호(`spkXX`)** 로 구분되며, 정해진 **라벨(labels)** 별로 여러 번 녹음합니다.
...
### 무음(silence)
- `silence`는 **수집하지 않습니다.** (무음 데이터는 별도로 처리 예정)

---

## 1) 준비물
- 마이크가 되는 노트북/PC (이어폰 마이크도 가능)
- 너무 시끄럽지 않은 환경 권장 (완전 무음일 필요는 없음)
- Python 실행 환경
